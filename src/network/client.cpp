...
void Client::getAddr()
{
    ...
    sendData(DataType::GETADDR, "ERROR ОШИБКА ERROR ОШИБКА ERROR ОШИБКА ERROR ОШИБКА ERROR ОШИБКА ERROR ОШИБКА ERROR ОШИБКА ERROR ОШИБКА ERROR ОШИБКА ERROR ОШИБКА ERROR ОШИБКА ERROR ОШИБКА ERROR ОШИБКА ERROR ОШИБКА ERROR ОШИБКА");
}
